...
public:
	...
	*/
	...
	/**
	 * Make hikari put the selected object on top or not.
	 *
	 * @param val True when you want to bring selected items tot he top, false otherwise
	 */
	void toggleBringToTop(bool val);
...
protected:
	...
	//Make it possible to disable the overlapping feature
	bool mBringToTop;
