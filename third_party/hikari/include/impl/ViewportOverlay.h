...
// PanelOverlayElement all moved into the separate Overlay component in
// modern Ogre (no longer transitively pulled in by "Ogre.h"/core headers).
...
public:
	...
	// tier/multi-tier z-ordering scheme was collapsed into a single flat
	// zOrder, widened from Ogre::uchar to Ogre::ushort.
	...
	void setZOrder(Ogre::ushort zOrder);
