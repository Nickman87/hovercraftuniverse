...
om deze versie (voorlopig) links te laten liggen.
 ...
 - **Ogre Max Viewer**: Bekijken van 3D Modellen - [Download](http://www.ogremax.com/Packages/OgreMaxViewers2.2.5.7z)
  - Bij ontbreken dlls (XINPUT1_3.dll, d3dx9_41.dll, ...), installeer de [DirectX End-User Runtimes](http://www.microsoft.com/downloads/details.aspx?displaylang=en&FamilyID=0cef8180-e94a-4f56-b157-5ab8109cb4f5).
 ...
 - **FMOD**: Geluid library - [FMOD Home](http://www.fmod.org/)
  ...
  - Closed source, enkel dll files maar wel heel flexibel
    - Handig voor omgevings-afhankelijke geluiden: [Theme_stack](http://www.fmod.org/wiki/index.php5?title=Theme_stack)
